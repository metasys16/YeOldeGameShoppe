...
export const GAMES: Game[]= [

	{
		...
		releaseYear: '1987',
		jacket:'../../../assets/images/jackets/Mario.jpg',
		pegi: 3
	},
	{ id: 2,
		name: 'Tetris',
	...
	{ id: 3,
		...
		creationDate: new Date(2017,9,12),
		editors: [{name: 'Nintendo'}],
		genres: [{name: 'plate-forme'}, {name: 'puzzle'}],
		platforms: [{name: 'GameBoy'}],
	...
	{ id: 4,
		...
		releaseYear: '1991',
		jacket:'../../../assets/images/jackets/Sonic.jpg',
		pegi:3
	},
	{ id: 5,
		name: 'Pokemon Rouge',
		...
		jacket:'../../../assets/images/jackets/PokemonRouge.jpg',
