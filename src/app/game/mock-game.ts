...
export const GAMES: Game[]= [
	{ id:1 , name:'Mario' , raite:5 , addDate:null , price:25 , editor:'Nintendo' , kindList:['plate-forme'] , 
	...
	{ id:2 , name:'Tetris' , raite:4.5 , addDate:null , price:15 , editor:'Divers' , kindList:['puzzle'] , platformList:['GameBoy'] , quantity:1 , 
	...
	{ id:3 , name:'Donkey Kong' , raite:4 , addDate:null , price:20 , editor:'Nintendo' , kindList:['plate-forme', 'puzzle'], 
	...
	{ id:4 , name:'Sonic' , raite:3.5 , addDate:null , price:23 , editor:'Sega' , kindList:['plate-forme'] , platformList:['Mega Drive','Master Systeme'] , quantity:2 , 
	...
	{ id:5 , name:'Pokemon Rouge' , raite:'5' , addDate:null , price:'17' , editor:'Game Freak' , kindList:['aventure'] , platformList:['Game Boy'] , quantity:4 , 
