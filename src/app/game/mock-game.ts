...
export const GAMES: Game[] = [
	{ id: 1 , name: 'Mario' , rate: 5 ,   editor: ['Nintendo'] , genre: [{name: 'plate-forme'}] , 
		platformList: [{name: 'NES'}, {name: 'GameBoy'}, {name: 'Nintendo64'}] ,  
	...
	{ id: 2 , name: 'Tetris' , rate: 4 ,  editor: ['Divers'] , genre: [{name: 'puzzle'}] , platformList: [{name: 'GameBoy'}] ,  
	...
	{ id: 3 , name: 'Donkey Kong' , rate: 4 ,   editor: ['Nintendo'] , genre: [{name: 'plate-forme'}, {name: 'puzzle'}], 
		platformList: [{name: 'GameBoy'}] ,  description: 'Donkey Kong est un jeu vid̩o de plates-formes/puzzle sorti en 1994 sur Game Boy. Le jeu a ̩t̩ d̩velopp̩ par Nintendo EAD et ̩dit̩ par Nintendo. Il est compatible avec les am̩liorations qu offre le Super Game Boy, accessoire permettant de jouer aux jeux Game Boy sur Super Nintendo. Il a inspir̩ la s̩rie de jeux lanc̩e par Mario vs. Donkey Kong sur Game Boy Advance.' , 
		jacket: '' , releaseDate: '1994' , pegi: 3 },
	{ id: 4 , name: 'Sonic' , rate: 3 ,   editor: ['Sega'] , genre: [{name: 'plate-forme'}] , platformList: [{name: 'Mega Drive'}, {name: 'Master Systeme'}] ,  
	...
	{ id: 5 , name: 'Pokemon Rouge' , rate: 4.5 ,   editor: ['Game Freak'] , genre: [{name: 'aventure'}] , platformList: [{name: 'Game Boy'}] ,  
